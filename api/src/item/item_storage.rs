...
impl ItemStorage {
    ...
    pub fn from_vec(value: Vec<ItemStack>, volume: ItemVolume) -> Result<Self, ItemStorageFromVecError> {
    ...
    pub fn capacity(&self) -> ItemCount {
        debug_assert_eq!(self.total_occupied_volume, Self::eval_total_occupied_volume(&self.content));
