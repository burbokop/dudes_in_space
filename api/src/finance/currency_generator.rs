...
static NAMES: &[&str] = &["Meme coin", "Dogecoin", "Burbokoin", "Credits", "Latinum", "$", "€", "₴", "Tax-free minimum"];
...
impl CurrencyGenerator {
    ...
    pub fn generate_name<R: Rng>(&self, rng: &mut R, bank_registry: &BankRegistry, person_info: &PersonInfo) -> String {
